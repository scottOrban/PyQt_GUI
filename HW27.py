...
#        grid = QGridLayout()
#        self.setLayout(grid)
#        names = ['C1s', 'Bck', '', 'Close', '7', '8', '9', '/', '4', '5', '6', '*', '1', '2', '3', '-', '0', '.', '=', '+']
...
# Reimplementing event handler, press 'Esc' key on the keyboard to escape
#import sys
#from PyQt5.QtCore import Qt
